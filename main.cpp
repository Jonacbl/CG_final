...
int main()
{
    ...
    std::vector<std::string> faces
    {
        ...
        "resources/textures/clouds/clouds1_west.bmp",   // ��
        "resources/textures/clouds/clouds1_down.bmp",   // ��
        "resources/textures/clouds/clouds1_up.bmp",     // ��
        "resources/textures/clouds/clouds1_north.bmp",  // ��
        "resources/textures/clouds/clouds1_south.bmp",  // ��
    };

    //std::vector<std::string> faces
    //{
    //    "resources/textures/park-skyboxes/Park2/posx.jpg",  // ��
    //    "resources/textures/park-skyboxes/Park2/negx.jpg",  // ��
    //    "resources/textures/park-skyboxes/Park2/negy.jpg",  // ��
    //    "resources/textures/park-skyboxes/Park2/posy.jpg",  // ��
    //    "resources/textures/park-skyboxes/Park2/posz.jpg",  // ǰ
    //    "resources/textures/park-skyboxes/Park2/negz.jpg"   // ��
    //};
